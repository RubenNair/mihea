...
DT5BlockNOTRotEllip_t::DT5BlockNOTRotEllip_t( int number_of_variables, int number_of_c_variables, double a ) : GBOFitnessFunction_t<char>(number_of_variables)
{
...
double DT5BlockNOTRotEllip_t::getLowerRangeBound( int dimension )
{
	return( -1e308 );
}
		
double DT5BlockNOTRotEllip_t::getUpperRangeBound( int dimension )
{
	return( 1e308 );
}
		
int DT5BlockNOTRotEllip_t::getNumberOfSubfunctions()
{
	return number_of_variables;
}
		
vec_t<int> DT5BlockNOTRotEllip_t::inputsToSubfunction( int subfunction_index )
{
	vec_t<int> vec;
...
double DT5BlockNOTRotEllip_t::subfunction( int subfunction_index, vec_t<char> &variables )
{
...
double DT5BlockNOTRotEllip_t::discrete_subfunction(int subfunction_index, vec_t<char> &variables)
{
	int sum = 0;
	for(int i = 0; i < k; i++) {
...
double DT5BlockNOTRotEllip_t::continuous_subfunction(int subfunction_index, vec_t<char> &variables, vec_t<double> &c_variables)
{
    ...
    double res = 0.0;
    for(int i = 0; i < k; i++) {
        res += pow(10, 6 * ((double)(i) / (double)(k - 1))) * pow(c_variables[subfunction_index * k + i] - ellipsoid_centre[i], 2);
    }
    return res;
}

void DT5BlockNOTRotEllip_t::evaluationFunction( solution_t<char> *solution )
{
...
double DT5BlockNOTRotEllip_t::objectiveFunction( int objective_index, solution_t<char> *solution )
{
    return objectiveFunction(objective_index,solution->fitness_buffers);
}

double DT5BlockNOTRotEllip_t::objectiveFunction( int objective_index, vec_t<double> &fitness_buffers )
{
    return fitness_buffers[objective_index];
}

double DT5BlockNOTRotEllip_t::constraintFunction( solution_t<char> *solution )
{
    return 0.0;
}
...
double **DT5BlockNOTRotEllip_t::initializeObjectiveRotationMatrix( double rotation_angle, int rotation_block_size )
{
...
double *DT5BlockNOTRotEllip_t::rotateVariables( double *variables, int num_variables, double **rotation_matrix )
{
