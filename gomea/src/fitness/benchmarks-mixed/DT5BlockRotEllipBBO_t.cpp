...
// DT5BlockRotEllipBBO_t::DT5BlockRotEllipBBO_t( int number_of_variables, int number_of_c_variables, double a ) : BBOFitnessFunction_t<int>(number_of_variables)
// {
...
// double DT5BlockRotEllipBBO_t::discrete_subfunction(int subfunction_index, vec_t<int> &variables)
// {
// 	int sum = 0;
// 	for(int i = 0; i < k; i++) {
...
// double DT5BlockRotEllipBBO_t::continuous_subfunction(int subfunction_index, vec_t<int> &variables, vec_t<double> &c_variables)
// {
...
// void DT5BlockRotEllipBBO_t::evaluationFunction( solution_t<int> *solution )
// {
...
// double DT5BlockRotEllipBBO_t::objectiveFunction( int objective_index, solution_t<int> *solution )
// {
// 	solution_mixed *solution_mix = static_cast<solution_mixed*>(solution);
// 	// For this function, there has to be an equal number of discrete and continuous variables
//     assert(solution_mix->getNumberOfVariables() == solution_mix->getNumberOfCVariables());
...
// double DT5BlockRotEllipBBO_t::objectiveFunction( int objective_index, vec_t<int> &variables )
// {
// 	cerr << "Wrong objectiveFunction used: DT5BlockRotEllipBBO_t::objectiveFunction( int objective_index, vec_t<int> &variables )\n";
// 	cerr << "Use: DT5BlockRotEllipBBO_t::objectiveFunction( int objective_index, solution_t<int> *solution )" << endl;
// 	exit( 0 );
// }

// double DT5BlockRotEllipBBO_t::constraintFunction( solution_t<int> *solution )
// {
// 	return 0.0;
// }
