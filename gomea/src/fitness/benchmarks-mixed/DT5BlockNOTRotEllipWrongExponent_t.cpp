...
DT5BlockNOTRotEllipWrongExponent_t::DT5BlockNOTRotEllipWrongExponent_t( int number_of_variables, int number_of_c_variables, double a ) : GBOFitnessFunction_t<char>(number_of_variables)
{
...
double DT5BlockNOTRotEllipWrongExponent_t::subfunction( int subfunction_index, vec_t<char> &variables )
{
...
double DT5BlockNOTRotEllipWrongExponent_t::discrete_subfunction(int subfunction_index, vec_t<char> &variables)
{
	int sum = 0;
	for(int i = 0; i < k; i++) {
...
double DT5BlockNOTRotEllipWrongExponent_t::continuous_subfunction(int subfunction_index, vec_t<char> &variables, vec_t<double> &c_variables)
{
...
void DT5BlockNOTRotEllipWrongExponent_t::evaluationFunction( solution_t<char> *solution )
{
...
double DT5BlockNOTRotEllipWrongExponent_t::objectiveFunction( int objective_index, solution_t<char> *solution )
{
...
double DT5BlockNOTRotEllipWrongExponent_t::constraintFunction( solution_t<char> *solution )
{
    return 0.0;
}
