...
DT5BlockRotEllip_t::DT5BlockRotEllip_t( int number_of_variables, int number_of_c_variables, double a ) : GBOFitnessFunction_t<int>(number_of_variables)
{
...
double DT5BlockRotEllip_t::subfunction( int subfunction_index, vec_t<int> &variables )
{
...
double DT5BlockRotEllip_t::discrete_subfunction(int subfunction_index, vec_t<int> &variables)
{
	int sum = 0;
	for(int i = 0; i < k; i++) {
...
double DT5BlockRotEllip_t::continuous_subfunction(int subfunction_index, vec_t<int> &variables, vec_t<double> &c_variables)
{
...
void DT5BlockRotEllip_t::evaluationFunction( solution_t<int> *solution )
{
...
double DT5BlockRotEllip_t::objectiveFunction( int objective_index, solution_t<int> *solution )
{
...
double DT5BlockRotEllip_t::constraintFunction( solution_t<int> *solution )
{
    return 0.0;
}
