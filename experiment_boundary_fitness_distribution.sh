...
for ((i=1; i<= $loops; i++)); do timeout 10m build/MixedIntegerGOMEA_O -P1004 -n1000 -O${folderBaseName}/${dataInputFile}/Method_1_init_1/run_${i} ${flags} >${consoleOutput}; done 
...
for ((i=1; i<= $loops; i++)); do timeout 10m build/MixedIntegerGOMEA_O -P1004 -n1000 -O${folderBaseName}/${dataInputFile}/Method_1_init_2/run_${i} ${flags} -u >${consoleOutput}; done 
...
for ((i=1; i<= $loops; i++)); do timeout 10m build/MixedIntegerGOMEA_O -P1004 -n1000 -O${folderBaseName}/${dataInputFile}/Method_1_init_3/run_${i} ${flags} -g >${consoleOutput}; done 
...
for ((i=1; i<= $loops; i++)); do timeout 10m build/MixedIntegerGOMEA_O -P1004 -n1000 -O${folderBaseName}/${dataInputFile}/Method_2_init_1/run_${i} ${flags} -t >${consoleOutput}; done 
# Init method 2, general method 2
for ((i=1; i<= $loops; i++)); do timeout 10m build/MixedIntegerGOMEA_O -P1004 -n1000 -O${folderBaseName}/${dataInputFile}/Method_2_init_2/run_${i} ${flags} -u -t >${consoleOutput}; done 
# Init method 3, general method 2
for ((i=1; i<= $loops; i++)); do timeout 10m build/MixedIntegerGOMEA_O -P1004 -n1000 -O${folderBaseName}/${dataInputFile}/Method_2_init_3/run_${i} ${flags} -g -t >${consoleOutput}; done 
